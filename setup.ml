...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6b49eace76ef60b2c8b927ea92ebc788) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_flow", ["-q"]))];
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-flow";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lwt_io_flow"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage_flow";
                      lib_findlib_name = Some "lwt-io";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Mirage block documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\187*Ncr\151X?\181|\128`?aS}";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
